...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Envelope icon. Color is inherited from parent.<p>`import { MdEnvelopeIcon } from '@md-components/md-react'`</p><p>`import { MdEnvelopeIcon64 } from '@md-components/md-react'`</p>",
      },
    },
  },
  argTypes: {
