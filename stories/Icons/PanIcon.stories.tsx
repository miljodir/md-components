...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Pan icon. Color is inherited from parent.<br/><br/>`import { MdPanIcon } from '@miljodirektoratet/md-react'`<br/>`import { MdPanIcon64 } from '@miljodirektoratet/md-react'`",
      },
    },
  },
  argTypes: {
