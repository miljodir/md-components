...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Print/printer icon. Color is inherited from parent.<br/><br/>`import { MdPrintIcon } from '@miljodirektoratet/md-react'`<br/>`import { MdPrintIcon64 } from '@miljodirektoratet/md-react'`",
      },
    },
  },
  argTypes: {
