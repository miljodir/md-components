...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Settings icon. Color is inherited from parent.<p>`import { MdSettingsIcon } from '@md-components/md-react'`</p><p>`import { MdSettingsIcon64 } from '@md-components/md-react'`</p>",
      },
    },
  },
  argTypes: {
