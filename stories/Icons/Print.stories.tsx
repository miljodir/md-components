...
export default {
  title: 'Icons/Print',
  component: MdIconPrint,
  parameters: {
    docs: {
      description: {
        component:
          // eslint-disable-next-line quotes
          "Print icon. Color can be inherited from parent, or set directly on the component. In addition to the properties presented here, the component accepts all standard attributes of a HTML SVG element.<br/><br/>`import { MdIconPrint } from '@miljodirektoratet/md-react'`",
      },
    },
  },
  argTypes: {
