...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: "Home/house icon. Color is inherited from parent.<p>`import { MdHomeIcon } from '@md-components/md-react'`</p><p>`import { MdHomeIcon64 } from '@md-components/md-react'`</p>",
      },
    },
  },
  argTypes: {
