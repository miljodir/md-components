...
export default {
  ...
  component: MdIconSignpost,
  parameters: {
    docs: {
      description: {
        component:
          // eslint-disable-next-line quotes
          "Signpost icon. Color can be inherited from parent, or set directly on the component. In addition to the properties presented here, the component accepts all standard attributes of a HTML SVG element.<br/><br/>`import { MdIconSignpost } from '@miljodirektoratet/md-react'`",
      },
    },
  },
  argTypes: {
