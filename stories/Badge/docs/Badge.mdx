...
<p style={{ textAlign: "right", marginTop: "0.75rem", marginBottom: 0 }}>
  <a href="https://github.com/miljodir/md-components/edit/main/stories/Badge/docs/Badge.mdx" target="_blank" rel="noreferrer" aria-label="Edit this documentation on GitHub" style={{ display: "inline-flex", alignItems: "center", opacity: 0.55, textDecoration: "none" }}>
