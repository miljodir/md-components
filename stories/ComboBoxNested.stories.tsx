    ...
    docs: {
      ...
      description: {
        component:
          ...
          "A component for combobox.<br/>Allows the user to select an entire group or values in that group. When a subset of a group is selected the group checkbox will be displayed as indeterminate.<br/><br/>`import { MdComboBoxNested } from '@miljodirektoratet/md-react'`",
      },
    },
  },
  argTypes: {
    options: {
      ...
      table: {
        type: {
          summary: '[{label: string, values: [{ value: string | number, text: string }, ...]}, ...]',
        },
      },
    },
    defaultOptions: {
    ...
    value: {
      ...
      description:
        'The currently selected values. A two dimensional array of strings.',
      table: {
        type: {
    ...
    onSelectOption: {
      ...
      description:
        'The handler for change events. Returns a two-dimensional array of strings',
      table: {
        type: {
          summary: 'function',
        },
...
export const ComboboxNested = Template.bind({});
