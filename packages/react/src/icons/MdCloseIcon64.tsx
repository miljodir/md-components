...
const MdCloseIcon64: React.FunctionComponent<MdIconProps> = ({
  ...
  return (
    ...
    >
      <g>
        <polygon points="22.25 43.16 32 33.41 41.75 43.16 43.16 41.75 33.41 32 43.16 22.25 41.75 20.84 32 30.59 22.25 20.84 20.84 22.25 30.59 32 20.84 41.75 22.25 43.16" fill="currentColor" />
