...
const MdCalendarIcon: React.FunctionComponent<MdIconProps> = ({
  ...
  return (
    ...
    >
      ...
      <path d="M27.4082 6.17776H24.0162V4.80176H22.4162V6.17776H8.2722V4.80176H6.6722V6.17776H3.2002V25.7618H27.4882V6.17776H27.4082ZM4.8002 24.1618V11.0098H25.8882V24.1618H4.8002Z" fill="currentColor"/>
    </svg>
