...
const MdDocIcon: React.FunctionComponent<MdDocIconProps> = ({
  ...
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="M6.40039 3.2002V27.4882H25.0564V9.4562L18.6564 3.2002H6.40039ZM8.00039 25.8882V4.8002H17.7124V10.5442H23.4564V25.8722L8.00039 25.8882Z" fill="currentColor"/>
