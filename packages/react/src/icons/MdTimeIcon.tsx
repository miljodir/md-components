...
const MdTimeIcon: React.FunctionComponent<MdIconProps> = ({
  className,
  ...otherProps
}: MdIconProps) => {
  return (
    ...
    >
      <g>
        ...
        <polygon points="9.63 7.31 8.63 7.31 8.63 12.69 13.88 12.69 13.88 11.69 9.63 11.69 9.63 7.31" fill='currentColor' />
      </g>
    </svg>
