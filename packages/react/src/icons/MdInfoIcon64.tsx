...
const MdInfoIcon64: React.FunctionComponent<MdIconProps> = ({
  className,
  ...otherProps
}: MdIconProps) => {
  return (
    ...
    >
      <g>
        <path d="M32,7.75A24.48,24.48,0,1,0,56.47,32.23,24.5,24.5,0,0,0,32,7.75Zm0,47A22.48,22.48,0,1,1,54.47,32.23,22.5,22.5,0,0,1,32,54.7Z" fill='currentColor' />
