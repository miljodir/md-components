...
const MdConfirmIcon64: React.FunctionComponent<MdIconProps> = ({ className, ...otherProps }: MdIconProps) => {
  ...
  console.warn('MdConfirmIcon is deprecated and will be removed in a future release.');
  ...
  return (
    ...
    >
      <path
        d="M28.7852 43.1696L20.9922 32.6406L22.5822 31.4756L28.8542 39.9496L43.4542 21.9346L44.9952 23.1786L28.7852 43.1696Z"
        fill="currentColor"
      />
