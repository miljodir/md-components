...
const MdDocIcon64: React.FunctionComponent<MdDocIconProps> = ({
  className = '',
  ...otherProps
}: MdDocIconProps) => {
  return (
    <svg
      ...
      {...otherProps}
    >
      <path d="M38.061 8H14V56H50.628V20.334L38.061 8ZM16.027 53.973V10.027H36.703V21.936H48.603V53.973H16.027Z" fill="currentColor"/>
