...
<div class="md-combobox md-combobox--[large|medium|small] [md-combobox--has-error]">
  ...
  <Ariakit.ComboboxPopover class="md-combobox__popover">
    ...
    <!-- Grouped options -->
    <div class="md-combobox__popover-groupedwrapper">
      <div class="md-combobox__group [md-combobox__group--no-separator]">
        <Ariakit.ComboboxItem class="md-combobox__checkbox-item md-combobox__group-label">
          <MdCheckbox label="Group label"/>
          <!-- selected in group / Number in group -->
          <MdIconKeyboardArrowDown />
        </Ariakit.ComboboxItem>
        <Ariakit.ComboboxItem class="combobox_nested_item_[md-combobox__checkbox-item--selected]">
...
The MdComboBoxNested component uses Ariakit's ComboBox component, which handles numerous accessibility attributes, including:
